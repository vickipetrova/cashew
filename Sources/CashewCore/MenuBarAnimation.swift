...
///
/// Most styles are drawn here in code rather than shipped as artwork: Cashew is going to track
...
/// Cashew's own character, drawn by the author, shipped as two sheets of frames — full colour,
...
enum MenuBarAnimation: String, CaseIterable {
    /// The ✻ spark, turning. What Cashew shipped first, and the default.
    case sparkSpin
