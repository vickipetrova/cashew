...
///
/// This is the first thing Headroom writes to disk, which is why the location is a parameter rather
...
final class UsageHistory {
    ...
    /// longest forecast uses — the extra headroom is so a Mac that was asleep for a weekend still has
    ...
    /// `~/Library/Application Support/com.vickipetrova.headroom/`.
